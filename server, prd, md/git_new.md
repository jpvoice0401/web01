...
|------|-----|
| **사용자 이름** | `jpvoice0401` |
| **사용자 이메일** | `artistpark85@gmail.com` |
| **리포 이름** | `web01` |
| **GitHub URL** | `https://github.com/jpvoice0401/web01.git` |
| **브랜치** | `main` |
| **배포 폴더** | `deploy/` (선택사항) |
...
### 0단계: (최초 1회) Git 사용자 정보 설정
```bash
# 전역 설정 (권장)
git config --global user.name "jpvoice0401"
git config --global user.email "artistpark85@gmail.com"
```
...
```bash
mkdir -p .ssh_temp
ssh-keygen -t ed25519 -C "artistpark85@gmail.com" -f .ssh_temp/id_ed25519 -N ""
```
